...
def _container_loopback_contract() -> tuple[bool, str]:
    ...
    acceptance_contract = (
        ...
        "podman pod create supports neither --hosts-file nor --no-hosts",
        "--cpus=2 --memory=2g",
    ...
    vulnerability_scan_contract = (
        ...
        "podman --remote run --rm -i --pull=never --http-proxy=false",
        "test -s artifacts/python-distributions.json",
        "python -m json.tool artifacts/python-distributions.json",
